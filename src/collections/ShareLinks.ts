...
export const ShareLinks: CollectionConfig = {
  ...
  admin: {
    ...
    description: 'Dynamic share links for article analytics tracking and anti-spam sharing.',
  },
  access: {
    read: () => true,
    create: ({ req }) => !!req.user,
  ...
  fields: [
    {
      ...
      unique: true,
      admin: {
        description: 'Auto-generated 5-character unique share key.',
        readOnly: true,
      },
    },
    {
    ...
    },
    {
      ...
      required: false,
      admin: {
        description: 'Optional tag/label (e.g. "FB Campaign", "Twitter Post").',
      },
    },
    {
      name: 'clicks',
